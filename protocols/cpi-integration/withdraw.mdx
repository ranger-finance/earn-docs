---
title: Withdraw
description: CPI instruction to complete a withdrawal from a Voltr vault
---
...
Full reference implementation: [withdraw_vault.rs](https://github.com/voltrxyz/vault-cpi/blob/main/references/withdraw_vault.rs)
