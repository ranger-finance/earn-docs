...
Full reference implementation: [cancel_request_withdraw_vault.rs](https://github.com/voltrxyz/vault-cpi/blob/main/references/cancel_request_withdraw_vault.rs)
