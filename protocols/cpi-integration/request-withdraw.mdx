...
description: CPI instruction to initiate a withdrawal from a Voltr vault
---
...
Full reference implementation: [request_withdraw_vault.rs](https://github.com/voltrxyz/vault-cpi/blob/main/references/request_withdraw_vault.rs)
