---
title: Deposit
description: CPI instruction to deposit assets into a Voltr vault
---
...
Full reference implementation: [deposit_vault.rs](https://github.com/voltrxyz/vault-cpi/blob/main/references/deposit_vault.rs)
